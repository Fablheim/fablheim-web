...
import { Loader2, ScrollText, Swords, Map, Sparkles, LogOut, StopCircle, MessageCircle, Activity, Clock, FileText, Wrench } from 'lucide-react';
...
import { SessionToolsDrawer } from '@/components/session/SessionToolsDrawer';
...
export function SessionRunnerPage({ campaignId, sessionId }: SessionRunnerPageProps) {
    ...
    return (
      <div className="flex h-full items-center justify-center bg-background">
        <AppEmptyState
          ...
          reason={campaignError ?? 'Campaign not found'}
          className="max-w-lg"
          primaryAction={
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      ...
      <SessionToolsDrawer
        ...
        isDM={isDM}
        selectedTokenEntryId={selectedTokenEntryId}
      />
  ...
  function renderHeader() {
    return (
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-[hsla(38,50%,40%,0.2)] shadow-[0_2px_10px_hsla(38,80%,50%,0.06)] texture-wood bg-card px-4 py-2 shrink-0">
        <div className="flex min-w-0 items-center gap-3">
          <h1 className="truncate font-semibold text-foreground font-[Cinzel] text-embossed text-sm">
            {campaign!.name}
          </h1>
          ...
          <button
            ...
            className="app-focus-ring inline-flex items-center gap-1.5 rounded-md border border-iron bg-accent px-2.5 py-1.5 text-[11px] font-[Cinzel] uppercase tracking-wide text-muted-foreground hover:text-foreground lg:hidden"
  ...
  function renderMain() {
    return (
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="session-sidebar-panel hidden lg:flex w-[280px] xl:w-[320px] flex-col border-r border-[hsla(38,40%,30%,0.15)] overflow-y-auto texture-parchment p-3">
            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-2.5 text-[11px] font-medium font-[Cinzel] tracking-wide transition-all border-b-2 ${
                    isActive
        ...
        <div className="session-sidebar-panel hidden xl:flex w-[280px] flex-col border-l border-[hsla(38,40%,30%,0.15)] overflow-y-auto texture-parchment p-3 gap-6">
