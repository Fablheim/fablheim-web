...
export function LiveSessionPage({ campaignId }: LiveSessionPageProps) {
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      {/* Header bar */}
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-[hsla(38,50%,40%,0.2)] shadow-[0_2px_10px_hsla(38,80%,50%,0.06)] texture-wood bg-card px-4 py-3 shadow-warm">
        <div className="flex min-w-0 items-center gap-4">
          {/* Campaign name */}
          <h1 className="truncate font-semibold text-foreground font-[Cinzel] text-embossed">
            {campaign.name}
          </h1>
